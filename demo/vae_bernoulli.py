...
os.makedirs('./results/vae_bernoulli', exist_ok=True)
...
class VAE(nn.Module):
    ...
    def forward(self, x, temp=1.0, hard=False):
        ...
        q_z = dist.RelaxedBernoulli(temp, logits=mu_logit)
        mu = q_z.probs
        ...
        for i, (data, _) in enumerate(test_loader):
            ...
            if i == 0:
                ...
                save_image(comparison.cpu(),
                           'results/vae_bernoulli/reconstruction_' + str(epoch) + '.png', nrow=n)
    ...
    for epoch in range(1, args.epochs + 1):
        ...
        with torch.no_grad():
            ...
            save_image(sample.view(64, 1, 28, 28),
                       'results/vae_bernoulli/sample_' + str(epoch) + '.png')