...
os.makedirs('./results/vae_categorical', exist_ok=True)
        ...
        for i, (data, _) in enumerate(test_loader):
            ...
            if i == 0:
                ...
                save_image(comparison.cpu(),
                           'results/vae_categorical/reconstruction_' + str(epoch) + '.png', nrow=n)
    ...
    for epoch in range(1, args.epochs + 1):
        ...
        with torch.no_grad():
            ...
            save_image(sample.view(64, 1, 28, 28),
                       'results/vae_categorical/sample_' + str(epoch) + '.png')